 ...
 * @author Zach
 * 
 *         TODO Change to fit more columns. This shouldn't just be for
 *         inventory. Tables for other information.
 */
public class SqlDatabase {
	...
	private static class DatabaseOpenHelper extends SQLiteOpenHelper {
		...
		private static final String TABLE_CREATE = "CREATE TABLE " + TABLE1
				+ " (" + KEY_ID2 + " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ KEY_sINGREDIENT + " TEXT NOT NULL" + ");";
		/** SQL to create second table of drinks */
		private static final String TABLE_CREATE2 = "CREATE TABLE " + TABLE2
				+ " (" + KEY_ID1 + " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ KEY_DRINK + " TEXT NOT NULL" + KEY_RATING
				+ " INTEGER NOT NULL" + KEY_AMOUNT + " TEXT NOT NULL"
