...
/**
 * This is a general class to handle 'Ingredients' without seperate tabs.
 */
public class Inv extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String al[] = (String[]) data.totalIngredients
				.toArray(new String[data.totalIngredients.size()]);
				...
				if (!data.ownedIngredients.contains((((TextView) view)
					...
					Toast.makeText(
							...
							"Added " + (((TextView) view).getText())
									+ " to Inventory", Toast.LENGTH_SHORT)
							.show();
					...
					Toast.makeText(
							...
							"Removed " + (((TextView) view).getText())
									+ " from Inventory", Toast.LENGTH_SHORT)
							.show();
